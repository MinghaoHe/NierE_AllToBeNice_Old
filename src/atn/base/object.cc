...
void Object::RemoveCurrentObject() {
  is_garbage_ = true;
}

bool Object::GarbageFlag() {
  return is_garbage_;
}
...
void
Object::SetBoundingBox(physics::BBoxType bbox_type, const glm::vec4& center,
...
physics::BoundingBox Object::GetBoundingBox() const {
...
bool Object::NeedCollisionDetection() const {
